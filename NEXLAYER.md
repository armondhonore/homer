...
**Live:** [https://relaxed-weasel-homer.cloud.nexlayer.ai](https://relaxed-weasel-homer.cloud.nexlayer.ai)  
...
**homer** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/b4bz/homer:latest
    path: /
    servicePorts:
    - 8080
    volumes:
